...
def train(env_name='CartPole-v0', hidden_dim=64, n_layers=2,
    ...
    def train_one_iteration(flag):
        ...
        while True:
            ...
            #print(act)
            #else:
            #    act= random.choice(np.arange(env.action_space.shape[0]))
    ...
    for i in range(n_iters):
        flag=False
        if i%20==0:flag=True
        batch_loss, batch_rets, batch_lens = train_one_iteration(flag)
